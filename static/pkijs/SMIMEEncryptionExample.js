/* This code was not written by me. It is imported from PKI.js.
 * If you want to learn more about this awesome cryptographic library,
 * visit https://pkijs.org
 */
"use strict";
   ...
   */
    ...
    */
	...
	function smimeEncrypt(vote) {
		...
		cmsEnveloped.encrypt(encAlg, stringToArrayBuffer(vote)).then(function () {
			...
			mimeMessage = btoa(mimeMessage);

			var x = document.forms["voting"];

			document.getElementById("display_vote").innerHTML = mimeMessage;
			//return mimeMessage;
			x["vote"].value = mimeMessage;
